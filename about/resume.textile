...
* Thor
* Vim
* AWS, Rackspace, and Heroku cloud platforms
...
* GitHub OAuth
* HTML5 localStorage
* Packaged two Sass libraries as Compass extensions and published them as RubyGems
...
Software Engineer
_Getty Images_
(Under contract through _Filter Digital_ from February to August)

* Maintained and developed marketing web pages and microsites using HTML5, CSS3, jQuery, and XML.
* Assumed lead role in the maintenance of a style guide framework for marketing portions of the website. The framework generates production CSS with Sass and establishes markup patterns that guide the way new pages are built. Converted from PHP to Sinatra soon after taking responsibility for the project.
* Co-authored a next-generation style guide framework for a strategic Ruby on Rails initiative. Engineered the framework's modularized structure, dynamic routing, and the Ruby Gem that forms the core Sass library. This framework was open-sourced and became Toadstool.
...
* Migrated hundreds of pages of content from a legacy CMS to a new one. Wrote a Ruby script to transform the hundreds of XML documents into HTML fragments that could be consumed by the new CMS, as well as locate and move thousands of graphics from the old system to the new one.


h3. 2005 – Present

Self-employed, Website Design/Maintenance, Programming, Development
