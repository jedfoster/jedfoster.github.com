...
* Assumed lead role in the maintenance of a style guide framework for marketing portions of the website. The framework generates production CSS with Sass and establishes markup patterns that guide the construction of new pages. Converted from PHP to Sinatra soon after taking responsibility for the project.
