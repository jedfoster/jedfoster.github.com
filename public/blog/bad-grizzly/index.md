Lately, there's been a lot of momentum around full-stack JavaScript apps; so when my friend [@anotheruiguy](https://twitter.com/anotheruiguy) asked me speak to his class at [Code Fellows](https://www.codefellows.org/) on Node.js and Ember, I took it as a challenge to explore some technologies that I had previously only played with. 
